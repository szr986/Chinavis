(function () {
    ...
    // 1. 实例化对象
    var myEcharts = echarts.init(document.getElementById('education'));
    // 2.指定配置
    var option = {
        title: {
