...
//实例化对象
$(".btn").click(function () {
    // $(this).siblings(".first").prop("value");
    datestr = $(".first").prop("value")
    console.log(datestr);
    ...
    $(document).ready(function () {
        form.on("select", function (data) {
            ...
            // 读取json文件
            $.ajax({
                url: '../../data/json/provincein/' + datestr + '/' + str1 + '.json',
                async: false,
                success: function (data) {
                    allData = data;
                }
            });
            var myChart = echarts.init(document.querySelector(".qianrumap .chart"));
            ...
            for (t = 0; t < 10; t++) {
                ...
                res3.push({
                    name: res2[res2.length - 1 - t].name,
                    value: res2[res2.length - 1 - t].value,
                })
            }
            console.log(res3)
            ...
            var convertData = function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    // if (chinaGeoCoordMap.name===str) {
                    //     pos=chinaGeoCoordMap[str];
                    // }
                    var toCoord = chinaGeoCoordMap[str];
                    // console.log(pos);
